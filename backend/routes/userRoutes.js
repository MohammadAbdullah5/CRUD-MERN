...
const { signin, signout, requireSignin, hasAuthorization } = require("../controllers/authController");
...
router.put("/api/users/:userId", hasAuthorization, update); // Handle PUT requests to /api/users/:userId using userController.update method.
